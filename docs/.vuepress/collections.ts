...
// const blog = defineCollection({
  ...
  //  exclude: ["**/README.md"] // 排除README.md文件
// })
...
const hyRecord = defineCollection({
  type: 'doc',
  dir: 'hy-record',
  title: '禾阅记录',
  autoFrontmatter: {
...
const periodical = defineCollection({
  type: 'doc',
  dir: 'periodical',
  title: '月刊',
  autoFrontmatter: {
...
const studentArticle = defineCollection({
  type: 'doc',
  dir: 'student-article',
  title: '学生投稿',
  autoFrontmatter: {
